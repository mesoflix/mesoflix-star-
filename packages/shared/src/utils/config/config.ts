...
export const domain_app_ids = {
    ...
    'deriv.app': 82976, // TODO: [app-link-refactor] - Remove backwards compatibility for `deriv.app`
    'app.deriv.com': 82976,
    'staging-app.deriv.com': 82976,
    'app.deriv.me': 82976,
    'staging-app.deriv.me': 82976, // TODO: setup staging for deriv.me
    'app.deriv.be': 82976,
    'staging-app.deriv.be': 82976,
    'binary.com': 1,
    'test-app.deriv.com': 82976,
};
...
export const getAppId = () => {
    let app_id = null;
    const user_app_id = '82976'; // you can insert Application ID of your registered application here
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 19112 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 82976; // it's being used in endpoint chrome extension - please do not remove
    } else if (/localhost/i.test(window.location.hostname)) {
        app_id = 82976;
    } else {
        window.localStorage.removeItem('config.default_app_id');
        app_id = is_bot ? 82976 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 82976;
    }
